...
?>
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                <li class="active">
                    <i class="glyphicon glyphicon-dashboard"></i> Dashboard / Rejected Orders
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="breadcrumb">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title"><i class="glyphicon glyphicon-remove"></i> Rejected Orders</div>
                    </div>
                    <div class="panel-body">
                        <table class="table table-responsive">
                            ...
                            <tr>
                                <?php
                                $order_qry="select * from customer_orders where shop_id='$shop_id' AND order_status='Rejected' order by order_id desc";
                                $run_order= mysqli_query($con, $order_qry);
                                if(mysqli_num_rows($run_order)==0)
                                {
                                ?>
                            <tr>
                                <td colspan="20" class="text-center text-danger" style="font-size: 16px;"><b>You Have No Rejected Orders</b></td>
                            </tr>
                            <?php
                            }
                            else{
